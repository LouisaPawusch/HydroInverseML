    ...
    def __init__(self, in_channel, filter_sizes, max_pool_kernel_sizes, dropout_rate, out_channels = None, stride = 1, batch_norm_momentum = 0.1, paddings=None, seed=0):
        ...
        for current_layer in range((self.num_hidden_layers+1) // 2):
            ...
            if (current_layer + 1) % 2 == 0:
                ...
                self.conv_layers.append(nn.MaxPool2d(kernel_size=(max_pool_kernel_sizes[pooling_counter],max_pool_kernel_sizes[pooling_counter]), stride=max_pool_kernel_sizes[pooling_counter], padding=max_pool_kernel_sizes[pooling_counter] // 2))
                pooling_counter += 1
