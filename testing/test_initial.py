...
def test_HIL_model():
    ...
    model = HIL_model(in_channel=4, filter_sizes=test_filter_sizes, max_pool_kernel_sizes=test_max_pool_kernel_sizes, dropout_rate=0.0, out_channels=test_out_channels, stride=1)
